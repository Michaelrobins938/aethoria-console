...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-console-dark mobile-full-height">
      ...
      {showIntro ? (
        <>
          ...
          <div className="fixed top-24 right-4 z-40">
            <a 
              href="/assistant-ui"
              className="inline-flex items-center space-x-2 px-4 py-2 bg-console-accent hover:bg-console-accent-dark text-console-dark font-console rounded-lg transition-colors duration-200 shadow-lg mobile-button"
            >
              <span>🧠</span>
              <span className="hidden sm:inline">Try Assistant-UI (v3)</span>
          ...
          {/* Games Section */}
          <section ref={gamesRef} className="py-10 md:py-20 px-4 relative">
            <div className="container mx-auto max-w-7xl">
              <div className="text-center mb-8 md:mb-16 animate-fade-in-up">
                <h2 className="text-3xl md:text-6xl font-gaming font-bold text-glow mb-4 md:mb-6">
                  GAME WORLDS
                </h2>
                <p className="text-lg md:text-xl text-console-text-dim max-w-3xl mx-auto leading-relaxed font-console">
          ...
          {/* About Section */}
          <section ref={aboutRef} className="py-10 md:py-20 px-4 relative">
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
              <div className="text-center mb-8 md:mb-16 animate-fade-in-up">
                ...
                <p className="text-lg md:text-xl text-console-text-dim max-w-4xl mx-auto leading-relaxed font-console">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="animate-slide-in-left">
                  <div className="console-panel">
                    <h3 className="text-xl md:text-2xl font-gaming font-bold text-console-accent mb-4 md:mb-6">
                      Our Mission
                    </h3>
                    <p className="text-console-text leading-relaxed mb-4 md:mb-6 font-console text-sm md:text-base">
                    ...
                    <p className="text-console-text leading-relaxed font-console text-sm md:text-base">
                  ...
                  <div className="console-panel">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-4 group">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-console-accent to-console-accent-dark rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <Gamepad2 className="w-5 h-5 md:w-6 md:h-6 text-console-dark" />
                        </div>
                        <div>
                          <h4 className="font-gaming font-bold text-console-text text-sm md:text-base">Next.js 14</h4>
                          <p className="text-xs md:text-sm text-console-text-dim font-console">Modern React Framework</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-4 group">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <Users className="w-5 h-5 md:w-6 md:h-6 text-white" />
                        </div>
                        <div>
                          <h4 className="font-gaming font-bold text-console-text text-sm md:text-base">OpenRouter AI</h4>
                          <p className="text-xs md:text-sm text-console-text-dim font-console">Advanced AI Models</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-4 group">
                        ...
                        <div>
                          <h4 className="font-gaming font-bold text-console-text text-sm md:text-base">Web Speech API</h4>
                          <p className="text-xs md:text-sm text-console-text-dim font-console">Voice Interaction</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          {/* Contact Section */}
          <section ref={contactRef} className="py-10 md:py-20 px-4 relative">
            <div className="container mx-auto max-w-4xl">
              <div className="text-center mb-8 md:mb-16 animate-fade-in-up">
                <h2 className="text-3xl md:text-6xl font-gaming font-bold text-glow mb-4 md:mb-6">
                  GET IN TOUCH
                </h2>
                <p className="text-lg md:text-xl text-console-text-dim max-w-2xl mx-auto leading-relaxed font-console">
              ...
              <div className="console-panel animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-4 group">
                        <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-console-accent to-console-accent-dark rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <Mail className="w-4 h-4 md:w-5 md:h-5 text-console-dark" />
                        </div>
                        <div>
                          <h4 className="font-gaming font-bold text-console-text text-sm md:text-base">Email</h4>
                          <p className="text-xs md:text-sm text-console-text-dim font-console">contact@aethoria.com</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-4 group">
                        <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                          <Users className="w-4 h-4 md:w-5 md:h-5 text-white" />
                        </div>
                        <div>
                          <h4 className="font-gaming font-bold text-console-text text-sm md:text-base">Discord</h4>
                          <p className="text-xs md:text-sm text-console-text-dim font-console">Join our community</p>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 console-button p-3 rounded-full shadow-console hover:scale-110 transition-transform duration-300 z-40 group mobile-button"
        title="Scroll to top"
      >
