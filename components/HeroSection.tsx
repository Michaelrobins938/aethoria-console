  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-12 max-w-6xl mx-auto px-4 pt-20">
        ...
        <div className="space-y-6 animate-fade-in-up">
          <div className="relative">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-gaming font-black text-glow neon-text">
              AETHORIA
            </h1>
            <div className="absolute inset-0 bg-gradient-to-r from-console-accent via-green-400 to-console-accent opacity-20 blur-3xl animate-pulse"></div>
          </div>
        ...
        {/* Epic Description */}
        <div className="space-y-8 text-lg md:text-xl lg:text-2xl text-console-text leading-relaxed max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="text-console-accent font-gaming text-xl md:text-2xl font-bold">
        ...
        {/* Call to Action */}
        <div className="space-y-6 mt-16 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button
              onClick={onStartAdventure}
              className="console-button-primary text-xl px-12 py-6 animate-pulse-glow group"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-gaming font-bold text-console-accent mb-2">100+</div>
            <div className="text-sm text-console-text-dim">Game Worlds</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-gaming font-bold text-blue-400 mb-2">∞</div>
            <div className="text-sm text-console-text-dim">Story Possibilities</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-gaming font-bold text-purple-400 mb-2">24/7</div>
            <div className="text-sm text-console-text-dim">AI Available</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-gaming font-bold text-green-400 mb-2">0</div>
            <div className="text-sm text-console-text-dim">Loading Screens</div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-console-accent rounded-full flex justify-center">
